...
export const openTrade = async (userId, tradeData) => {
    ...
    try {
        ...
        if (userBook === "B Book") {
            ...
            session.endSession();
            return { message: 'Trade saved successfully', trade: savedTrade, userId };
        }
        ...
        if (userBook === "A Book") {
            ...
            return { message: 'Trade executed successfully', trade: savedTrade, userId };
        }
...
export const closeTrade = async (userId, tradeId, closePrice) => {
    ...
    try {
        ...
        return { message: 'Trade closed successfully', trade, userId };
    } catch (error) {
        await session.abortTransaction();
        session.endSession();
